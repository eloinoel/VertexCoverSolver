...
//            std::cout << "u in N(c2): " << nC2->at(i) << " with deg(u): " << G->getVertexDegree(nC2->at(i)) << '\n';
        ...
        else if(connections == 2)
        {
            ...
            {
                if(G->deg4clique)
                std::cout << "Connections not independent!\n";
                delete neighbours;
                continue;
            }

            for (int j = 0; j < 4; ++j)
                if(nodesConnection[j] != 1)
                    throw std::invalid_argument("Wrong interpretation");
            ...
            else if (connectionAD){
                c1_2 = d;
                c2_1 = c;
                c2_2 = b;
            }
            else if (connectionAC){
                c1_2 = c;
                c2_1 = b;
                c2_2 = d;
            }
            ...
            if(c1_2 == b) { nC2_1 = nC; nC2_2 = nD;}
            else if(c1_2 == d) { nC2_1 = nC; nC2_2 = nB;}
            else if(c1_2 == c) { nC2_1 = nB; nC2_2 = nD;}
